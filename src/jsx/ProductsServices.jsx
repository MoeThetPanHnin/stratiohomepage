...
const products = [
  {
    name: 'LinkSquare',
    logo: '/img/homeimg/LinkSquarelogo.png',
    bg: 'img/products&servicesimg/Product%20img_02_2.png',
  ...
  {
    name: 'BeyonSense',
    logo: '/img/homeimg/BeyonSenselogo.png',
    bg: 'img/products&servicesimg/product_BeyonSense.png',
  ...
  {
    name: 'STNF',
    logo: '/img/homeimg/STNFlogo.png',
    bg: 'img/products&servicesimg/product_STNF.png',
