      ...
      <footer className="footer">
        <div className="footer-left">
          ...
          <p className="footer-copyright">
            Copyright © 2025 STRATIO, INC. All rights reserved.
          </p>
        </div>
        <div className="footer-right">
          <div className="social-icons">
            <a
              href="https://www.facebook.com/LinkSquareIR"
              target="_blank"
            ...
            <a
              href="https://www.youtube.com/@StratioBeyonSenseLinkSquare"
              target="_blank"
              rel="noopener noreferrer"
              className="icon-box"
              aria-label="YouTube"
            ...
            <a
              href="https://www.linkedin.com/company/stratioinc/"
              target="_blank"
              rel="noopener noreferrer"
              className="icon-box"
              aria-label="LinkedIn"
