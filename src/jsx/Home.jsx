    ...
    <>
      ...
      <section className="products">
        <div
          ...
          style={{ backgroundImage: `url(${linksquare})` }}
        >
          <div className="product-overlay">
            <img
              src={LinkSquarelogo}
              alt="LinkSquare Logo"
              className="product-logo , link-square-logo"
            />
            <div className="product-underline"></div>
            <p className="product-desc">
              Spectral Insight in the Palm of Your Hand
            </p>
            <p className="product-detail">
              LinkSquare is a smart handheld spectrometer powered by STRATIO's
              Ge-based SWIR spectral sensor. It captures spectral fingerprints
              across 8 channels among SWIR range to analyze and identify
              materials in real time, from plastics and fabrics to food and
              pharmaceuticals
            </p>
            <a
              href="https://linksquare.io/"
              className="product-btn link-square-btn"
              target="_blank"
        ...
        <div
          className="product-card"
          style={{ backgroundImage: `url(${beyonsense})` }}
        >
          <div className="product-overlay">
            <img
              src={BeyonSenselogo}
            ...
            <p className="product-detail">
              The only SWIR imaging solution built with STRATIO's Ge-based image
              sensor, a breakthrough that redefines what's possible in infrared
              vision. From autonomous vehicles to next-generation smartphones,
              BeyonSense is unlocking entirely new markets where seeing beyond
              visible means seeing further, safer, and smarter.
            </p>
            <a
              href="https://beyonsense.io/"
        ...
        <div
          className="product-card product-card-stnf"
          style={{ backgroundImage: `url(${stnf})` }}
        >
          <div className="product-overlay">
            ...
            <p className="product-detail">
              STNF is a Lab-to-Fab Foundry that supports startups disrupting the
              market, research institutions, and large corporations in
              transitioning from R&D to the commercial foundry production.
            </p>
            <a
              href="https://stnf.io/"
              className="product-btn"
      ...
      <section className="partner slide" id="logo-slide-01">
        <div className="inner">
          <div className="box">
            <img src={customer_logo_fit_1} alt="Olam" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_2} alt="USDA" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_3} alt="AgResearch" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_4} alt="Hortifrut" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_5} alt="Aerobotics" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_6} alt="Demetria" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_7} alt="INIA" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_8} alt="Smart Water Group" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_9} alt="Biolumic" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_10} alt="Libios" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_11} alt="Cornell University" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_12} alt="Illinois" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_13} alt="UCLA" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_14} alt="Kennesaw State University" />
          </div>
          <div className="box">
            <img
              src={customer_logo_fit_15}
              alt="Florida International University"
            />
          </div>
          <div className="box">
            <img src={customer_logo_fit_16} alt="University of New Hampshire" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_17} alt="Wageningen University" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_18} alt="Johns Hopkins University" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_19} alt="LG" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_20} alt="Pfizer" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_21} alt="Samsung" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_22} alt="US CBP" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_23} alt="NIST" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_24} alt="KOMSCO" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_25} alt="Thermo Fisher Scientific" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_26} alt="Microtrace" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_27} alt="Sanyo Chemical" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_28} alt="Children's National" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_29} alt="Hitachi" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_30} alt="Viavi Solutions" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_31} alt="NIH" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_32} alt="NEC" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_33} alt="Nepes" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_34} alt="Mitsubishi Heavy Industries" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_35} alt="Sun Insurance" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_36} alt="Bystronic" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_37} alt="VA Tech" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_38} alt="LG Display" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_39} alt="DSTL" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_40} alt="NMBU" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_41} alt="TechInsights" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_42} alt="RIT" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_43} alt="Intuitive Surgical" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_44} alt="Precision Planting" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_45} alt="UiT" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_46} alt="Apple" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_47} alt="Tricas" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_48} alt="SCOUT" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_49} alt="Thales Alenia Space" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_50} alt="AMS" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_51} alt="Acorn" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_52} alt="Nonasys" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_53} alt="Breakwater Research" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_54} alt="Ceremorphic" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_55} alt="SunDiode" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_56} alt="Microchip" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_57} alt="Ladybug" />
          </div>
          <div className="box">
            <img
              src={customer_logo_fit_58}
              alt="Sandia National Laboratories"
            />
          </div>
          <div className="box">
            <img src={customer_logo_fit_59} alt="HRL" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_60} alt="LLNL" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_61} alt="Analog Devices" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_62} alt="UCSF" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_63} alt="Applied Materials" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_64} alt="Torramics" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_65} alt="PrimeNano" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_66} alt="Plamatherm" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_67} alt="Pumpkin Seed" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_68} alt="Stanford" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_69} alt="MEMS" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_70} alt="Raxium" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_71} alt="Northwest Hub" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_72} alt="UC Davis" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_73} alt="Carbon3D" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_74} alt="University of Texas" />
          </div>
          <div className="box">
            <img src={customer_logo_fit_75} alt="UC Berkeley" />
          </div>
      ...
      <section className="contact">
        <div className="contact-info">
          ...
          <div className="us-address" style={{ marginBottom: "1.5rem" }}>
            2211 Fortune Drive, Suite A, San Jose, CA 95131
          </div>
          <div className="kr">KR Office.</div>
          <div className="kr-address" style={{ marginBottom: "1.5rem" }}>
            B-911, 43 Changeop-ro, Sujeong-gu, Seongnam-si, Gyeonggi-do (13449)
          </div>
          <div className="mail">Mail.</div>
          <div className="mail-address" style={{ marginBottom: "1.5rem" }}>
