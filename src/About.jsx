      ...
      <section className="about-hero">
        <div className="about-hero-content">
          ...
          <div className="about-hero-description">
            <p>STRATIO is the first and only company in the world to commercialize Germanium (Ge)-based SWIR sensors</p>
            <p>using standard CMOS processes. This breakthrough delivers what InGaAs never could:</p>
            <p>high-sensitive, mass-producible, and AI-integrated SWIR sensors that are ready for real-world impact.</p>
          </div>
        </div>
